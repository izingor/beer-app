export const BeerCard = ({
	...
	return (
		<div
			className="card break-inside-avoid  mb-4 border-gray_border border shadow drop-shadow-md rounded-lg   bg-no-repeat bg-right-bottom bg-[length:50px_125px] bg-origin-content p-3 "
